      ...
      <div class="col-sm-6">
        <div class="form-group">
          ...
          <span class="input-group-addon"><i class="fa fa-fw fa-dollar"></i></span>
            <input type="text" class="form-control" name="price_multiplier" placeholder="1.2"/>
          </div>
        </div>
      </div>
      <div class="col-sm-6">
        ...
        <div class="form-group">
          ...
          <select class="selectize_category" name="export_fields[]">
            ...
            <?php foreach (array(
              ...
              'product_id','model','name','link','description','sku','upc','ean','jan','isbn','mpn','location','quantity','store','stock_status_id','image','manufacturer','manufacturer_id','tag','meta_title','meta_h1','meta_description','meta_keyword','seo_keyword','additional_images','product_filter','product_attribute','product_option','product_category','product_discount','product_special','shipping','price','points','tax_class_id','date_available','weight','weight_class_id','length','width','height','length_class_id','subtract','minimum','sort_order','status','viewed','date_added','date_modified',
            ) as $field) { ?>
